...
Rectangle {
                            ...
                            onClicked: {
                                ...
                                try {
                                    ...
                                    if (result && result.success) {
                                        ...
                                        let errorMsg = result && result.error ? result.error : "Unknown error"
                                        dataUploadStatus.text = root.isChinese ? 
                                            `上传失败: ${errorMsg}` : `Upload failed: ${errorMsg}`
                        ...
                        delegate: Rectangle {
                            ...
                            RowLayout {
                                ...
                                Button {
                                    ...
                                    onClicked: {
                                        console.log("Preview button clicked for table:", modelData)
                                        ...
                                        root.selectedTable = modelData
                                        previewTable(modelData)
                                    }
                                }
                                ...
                                Button {
                                    ...
                                    onClicked: {
                                        console.log("Delete button clicked for table:", modelData)
                                        console.log("continuousLearningController:", root.continuousLearningController)
                                        deleteConfirmDialog.tableName = modelData
    ...
    function previewTable(tableName) {
        ...
        if (root.continuousLearningController) {
            console.log("Controller exists, calling previewTableData...")
            try {
    ...
    Component.onCompleted: {
        console.log("DataManagement_Simple.qml Component.onCompleted")
        console.log("continuousLearningController:", root.continuousLearningController)
        console.log("typeof continuousLearningController:", typeof root.continuousLearningController)
